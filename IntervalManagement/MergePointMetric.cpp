...
bool MergePointMetric::willReportMetrics() const { return mReportMetrics; }

int MergePointMetric::GetImAcId() const { return m_im_ac_id; }

int MergePointMetric::GetTargetAcId() const { return m_target_ac_id; }
