...
KinematicTrajectoryPredictor::KinematicTrajectoryPredictor(std::shared_ptr<const aaesim::BadaPerformanceCalculator> bada_calculator,
   ...
   kinematic_descent_predictor->SetMembers(transition_mach, transition_ias, cruise_altitude_msl, transition_altitude_msl);
   kinematic_descent_predictor->m_bada_calculator = std::move(bada_calculator);
...
void KinematicTrajectoryPredictor::CalculateWaypoints(const AircraftIntent &aircraft_intent, const WeatherPrediction &weather_prediction) {
