...
int ClosestPointMetric::GetImAcId() const { return m_im_ac_id; }

bool ClosestPointMetric::IsReportMetrics() const { return m_report_metrics; }

int ClosestPointMetric::GetTargetAcId() const { return m_target_ac_id; }
