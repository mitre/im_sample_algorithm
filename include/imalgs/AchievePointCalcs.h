...
namespace interval_management
{
   ...
   public:
       ...
       * @param acstate
       */
      void ComputeCrossingTime(const interval_management::AircraftState &acstate);

      const Units::Length ComputeDistanceToWaypoint(const interval_management::AircraftState &acstate);

      const bool HasWaypoint() const;

      const bool IsWaypointPassed(const interval_management::AircraftState &acstate);
