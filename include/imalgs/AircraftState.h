...
namespace interval_management
{
   ...
   public:
      ...
      AircraftState &Create(const int& id,
   ...
   private:
      ...
      int m_id;
      Units::Time m_time;
      Units::Speed m_sensed_wind_east_component, 
                   m_sensed_wind_north_component,
                   m_sensed_wind_perpendicular_component,
   ...
   inline Units::SecondsTime AircraftState::GetTimeStamp() const
   {
      return m_time;
   }

   inline int AircraftState::GetId() const
   {
      return m_id;
   }

   inline Units::SignedRadiansAngle AircraftState::GetPsi() const 
   {
      return m_psi_enu;
   }

   inline Units::RadiansAngle AircraftState::GetGamma() const
   {
      return m_gamma;
   }

   inline Units::Temperature AircraftState::GetSensedTemperature() const
   {
      return m_sensed_temperature;
   }

   inline Units::Speed AircraftState::GetSensedWindParallelComponent() const
   {
      return m_sensed_wind_parallel_component;
   }
   ...
   inline Units::Speed AircraftState::GetSensedWindEastComponent() const {
      return m_sensed_wind_east_component;
   }

   inline Units::Speed AircraftState::GetSensedWindNorthComponent() const {
      return m_sensed_wind_north_component;
   }
